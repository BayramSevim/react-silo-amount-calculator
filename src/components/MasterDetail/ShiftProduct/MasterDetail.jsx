...
const App = ({ dateS, dateF, productId, shift }) => {
  ...
  useEffect(() => {
    const url = `${GetAPIUrl()}/api/Product/GetProductCumByDateAndShift?dateS=${formattedDateS}&dateF=${formattedDateF}&productId=${productId}&shift=${shift}`;
  ...
  }, [formattedDateS, formattedDateF, productId, shift]);
